...
C {madvlsi/vdd.sym} 650 -160 0 0 {name=l1 lab=VDD}
C {madvlsi/vsource.sym} 650 -130 0 0 {name=Vdd
value=1.8}
C {madvlsi/gnd.sym} 650 -100 0 0 {name=l2 lab=GND}
C {madvlsi/vdd.sym} 245 -100 0 0 {name=l3 lab=VDD}
C {madvlsi/gnd.sym} 245 40 0 0 {name=l4 lab=GND}
C {madvlsi/gnd.sym} 710 -100 0 0 {name=l6 lab=GND}
C {devices/lab_pin.sym} 710 -160 1 0 {name=l7 sig_type=std_logic lab=Vb}
C {devices/lab_pin.sym} 170 -60 0 0 {name=l8 sig_type=std_logic lab=Vb}
C {madvlsi/isource.sym} 710 -130 0 0 {name=Ib
value=1.2u}
C {devices/code_shown.sym} -15 -335 0 0 {name=SPICE only_toplevel=false value=".control
set wr_vecnames
set wr_singlescale
...
C {madvlsi/vsource.sym} 650 20 0 0 {name=V1
value="1.8"}
C {madvlsi/gnd.sym} 650 50 0 0 {name=l12 lab=GND}
C {devices/lab_pin.sym} 650 -10 1 0 {name=l11 sig_type=std_logic lab=V1}
C {devices/lab_pin.sym} 360 -120 0 0 {name=l16 sig_type=std_logic lab=V1}
C {madvlsi/vsource.sym} 710 20 0 0 {name=V2
value="1.8"}
C {madvlsi/gnd.sym} 710 50 0 0 {name=l13 lab=GND}
C {devices/lab_pin.sym} 710 -10 1 0 {name=l14 sig_type=std_logic lab=V2}
C {devices/lab_pin.sym} 360 -100 0 0 {name=l15 sig_type=std_logic lab=V2}
C {madvlsi/tt_models.sym} -15 -120 0 0 {
name=TT_MODELS
only_toplevel=false
